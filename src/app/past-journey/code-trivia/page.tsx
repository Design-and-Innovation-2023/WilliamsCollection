                    ...
                    <div className="space-y-5 xl:col-span-3">
                      <div className="space-y-6">
                        <div className="prose max-w-none text-white text-justify">
                          The QR Code quiz/game is a museum scavenger hunt where
                          visitors scan a QR code at the entrance, leading them
                          on an adventure to find a mystery object. By solving
                          quizzes and games related to exhibits, they receive
                          hints to locate QR codes hidden throughout the museum.
                          When the initial QR code matches the object's QR code,
                          they win the game.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-5 xl:col-span-3">
                      <div className="space-y-6">
                        ...
                        <div className="prose max-w-none text-white text-justify dark:text-white">
                          ...
                          <br />
                          3. The user plays a series of games or quizzes which
                          leads them to the object
                          <br />
                          4. Each object in the museum contains a QR code
                          <br />
                          5. To win the game, the user must scan the QR code of
                          the object they find and match it with the right
                          answer obtained during the games.
                        </div>
                      </div>
                    </div>
                  </div>
