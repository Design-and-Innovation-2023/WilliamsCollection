                  ...
                  <div className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                    ...
                    <div className="space-y-5 xl:col-span-3">
                      ...
                      <div className="prose max-w-none text-white text-justify dark:text-white">
                        <div className="flex">
                          <div className="team-list" style={{ marginRight: '50px' }}>
                            <p className="font-bold underline decoration-solid">Team 3A</p>
                            <ul>
                          ...
                          <div className="team-list">
                            <p className="font-bold underline decoration-solid">Team 3B</p>
                            <ul>
                              <li>Shyam Prasad</li>
                              <li>Tan Xin Jie</li>
                  ...
                  <div className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                    ...
                    <div className="space-y-5 xl:col-span-3">
                      <div className="space-y-6">
                        ...
                        <p>
                          <br></br>
                          Each team came up with 3 different solutions that target our age group respectively.
                          <br></br>
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <ul className="list-decimal">
                            ...
                            <p>
                            A QR code quiz game, where users will move around the museum to scan 
                            QR code to be redirected in to a webpage. At the webpage there are a 
                            series of quizzes about artefacts where visitors have to guess which 
                            ...
                            <p>
                            Multiplayer Co-op where one performs an activity at one area of the museum 
                            and another player performs another activity at another part of the museum. 
                            They’ll need to collaborate to find out the full information to win the game. 
